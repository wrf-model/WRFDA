...
gen_be_ep1     : gen_be_ep1.o $(GEN_BE_OBJS)
	$(LD) -o gen_be_ep1.exe $(LDFLAGS) $(GEN_BE_OBJS)  gen_be_ep1.o $(GEN_BE_LIB)

gen_be_ep2     : gen_be_ep2.o $(GEN_BE_OBJS)
