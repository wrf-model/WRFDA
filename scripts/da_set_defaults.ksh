...
typeset -i tmptime=$FCST_RANGE
let tmptime=$CYCLE_PERIOD/3600
export NL_RUN_HOURS=$tmptime
let tmptime=$CYCLE_PERIOD-$NL_RUN_HOURS*3600
let tmptime=tmptime/60
export NL_RUN_MINUTES=$tmptime
let tmptime=$CYCLE_PERIOD-$NL_RUN_HOURS*3600-$NL_RUN_MINUTES*60
export NL_RUN_SECONDS=$tmptime
...
export NL_INPUTOUT_END_M=${NL_INPUTOUT_END_M:-$(( (FCST_RANGE-NL_INPUTOUT_END_H*3600)/60 ))} # Output input format end.
