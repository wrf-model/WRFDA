...
export TIME_WINDOW_MIN=${END_YEAR}-${END_MONTH}-${END_DAY}_${END_HOUR}:${END_MINUTE}:${END_SECOND}
export FCST_RANGE=$MAX_OB_RANGE
. $WRFVAR_DIR/scripts/da_get_date_range.ksh
export TIME_WINDOW_MAX=${END_YEAR}-${END_MONTH}-${END_DAY}_${END_HOUR}:${END_MINUTE}:${END_SECOND}
export FCST_RANGE=0
. $WRFVAR_DIR/scripts/da_get_date_range.ksh
export TIME_ANALYSIS=${START_YEAR}-${START_MONTH}-${START_DAY}_${START_HOUR}:${END_MINUTE}:${END_SECOND}
