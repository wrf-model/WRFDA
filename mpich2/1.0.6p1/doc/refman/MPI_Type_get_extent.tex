\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}get{\tt \char`\_}extent}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}get{\tt \char`\_}extent}
...
\startarg{lb }{lower bound of datatype (integer) 
}
\startarg{extent }{extent of datatype (integer) 
}
\par
...
\location{type{\tt \char`\_}get{\tt \char`\_}extent.c}
\endmanpage
