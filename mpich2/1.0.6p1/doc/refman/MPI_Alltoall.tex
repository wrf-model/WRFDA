\startmanpage
\mantitle{MPI{\tt \char`\_}Alltoall}{tex}{11/8/2006}
\manname{MPI{\tt \char`\_}Alltoall}
...
\startarg{sendcount }{number of elements to send to each process (integer) 
}
\startarg{sendtype }{data type of send buffer elements (handle) 
}
\startarg{recvcount }{number of elements received from any process (integer) 
}
