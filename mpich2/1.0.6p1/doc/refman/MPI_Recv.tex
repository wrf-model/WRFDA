\startmanpage
\mantitle{MPI{\tt \char`\_}Recv}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Recv}
...
\startarg{count }{maximum number of elements in receive buffer (integer) 
}
...
\par
\subhead{Notes}
The {\tt count} argument indicates the maximum length of a message; the actual
length of the message can be determined with {\tt MPI{\tt \char`\_}Get{\tt \char`\_}count}.
\par
