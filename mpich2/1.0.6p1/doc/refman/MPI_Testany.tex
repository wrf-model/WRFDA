\startmanpage
\mantitle{MPI{\tt \char`\_}Testany}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Testany}
...
\startarg{index }{index of operation that completed, or {\tt MPI{\tt \char`\_}UNDEFINED}  if none 
completed (integer) 
}
\startarg{flag }{true if one of the operations is complete (logical) 
}
