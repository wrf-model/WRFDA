\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}call{\tt \char`\_}errhandler}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}call{\tt \char`\_}errhandler}
...
\startarg{comm }{communicator with error handler (handle) 
}
...
\location{comm{\tt \char`\_}call{\tt \char`\_}errhandler.c}
\endmanpage
