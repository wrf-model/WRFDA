\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}set{\tt \char`\_}errhandler}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}set{\tt \char`\_}errhandler}
...
\startarg{errhandler }{new error handler for communicator (handle) 
}
\par
\par
...
\par
\subhead{See Also}
MPI{\tt \char`\_}Comm{\tt \char`\_}get{\tt \char`\_}errhandler, MPI{\tt \char`\_}Comm{\tt \char`\_}call{\tt \char`\_}errhandler
\nextline
\location{comm{\tt \char`\_}set{\tt \char`\_}errhandler.c}
\endmanpage
