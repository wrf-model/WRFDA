\startmanpage
\mantitle{MPI{\tt \char`\_}File{\tt \char`\_}set{\tt \char`\_}errhandler}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}File{\tt \char`\_}set{\tt \char`\_}errhandler}
...
\startarg{errhandler }{new error handler for file (handle) 
}
\par
\par
...
\location{file{\tt \char`\_}set{\tt \char`\_}errhandler.c}
\endmanpage
