\startmanpage
\mantitle{MPI{\tt \char`\_}Errhandler{\tt \char`\_}free}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Errhandler{\tt \char`\_}free}
...
\startarg{errhandler }{MPI error handler (handle).  Set to {\tt MPI{\tt \char`\_}ERRHANDLER{\tt \char`\_}NULL} on 
exit.
}
\par
...
\location{errhandler{\tt \char`\_}free.c}
\endmanpage
