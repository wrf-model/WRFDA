\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}set{\tt \char`\_}name}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}set{\tt \char`\_}name}
...
\startarg{MPI{\tt \char`\_}Comm comm }{communicator to name (handle)
}
\startarg{char *comm{\tt \char`\_}name }{Name for communicator
}
\par
\par
...
\location{comm{\tt \char`\_}set{\tt \char`\_}name.c}
\endmanpage
