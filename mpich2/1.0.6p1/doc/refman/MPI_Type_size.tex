\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}size}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}size}
...
\startarg{size }{datatype size (integer) 
}
\par
