\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}remote{\tt \char`\_}size}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}remote{\tt \char`\_}size}
...
\startarg{size }{number of processes in the remote group of {\tt comm}  (integer) 
}
\par
...
\location{comm{\tt \char`\_}remote{\tt \char`\_}size.c}
\endmanpage
