\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}test}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}test}
...
\startarg{flag }{success flag (logical) 
}
\par
\subhead{Notes}
...
\par
\subhead{See Also}
 MPI{\tt \char`\_}Win{\tt \char`\_}wait, MPI{\tt \char`\_}Win{\tt \char`\_}post
\nextline
\location{win{\tt \char`\_}test.c}
\endmanpage
