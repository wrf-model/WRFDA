\startmanpage
\mantitle{MPI{\tt \char`\_}Info{\tt \char`\_}dup}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Info{\tt \char`\_}dup}
...
\startarg{newinfo }{duplicate of info object (handle)
}
\par
\par
