\startmanpage
\mantitle{MPI{\tt \char`\_}Graphdims{\tt \char`\_}get}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Graphdims{\tt \char`\_}get}
...
\startarg{comm }{communicator for group with graph structure (handle) 
}
\par
\subhead{Output Parameters}
\startarg{nnodes }{number of nodes in graph (integer) 
}
\startarg{nedges }{number of edges in graph (integer) 
}
\par
