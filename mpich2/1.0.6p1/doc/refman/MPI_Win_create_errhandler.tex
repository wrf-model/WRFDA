\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}create{\tt \char`\_}errhandler}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}create{\tt \char`\_}errhandler}
...
\location{win{\tt \char`\_}create{\tt \char`\_}errhandler.c}
\endmanpage
