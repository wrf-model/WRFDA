\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}wait}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}wait}
--- Completes an RMA exposure epoch begun with MPI{\tt \char`\_}Win{\tt \char`\_}post 
\subhead{Synopsis}
