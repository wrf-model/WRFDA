\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}contiguous}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}contiguous}
...
\startarg{count }{replication count (nonnegative integer) 
}
...
\location{type{\tt \char`\_}contiguous.c}
\endmanpage
