\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}free{\tt \char`\_}keyval}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}free{\tt \char`\_}keyval}
...
\startarg{comm{\tt \char`\_}keyval }{Frees the integer key value (integer) 
}
\par
\subhead{Notes}
...
\location{comm{\tt \char`\_}free{\tt \char`\_}keyval.c}
\endmanpage
