\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}complete}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}complete}
--- Completes an RMA operations begun after an MPI{\tt \char`\_}Win{\tt \char`\_}start. 
\subhead{Synopsis}
...
\location{win{\tt \char`\_}complete.c}
\endmanpage
