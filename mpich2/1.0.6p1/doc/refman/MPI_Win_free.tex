\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}free}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}free}
...
\par
\subhead{Notes}
If successfully freed, {\tt win} is set to {\tt MPI{\tt \char`\_}WIN{\tt \char`\_}NULL}.
\par
