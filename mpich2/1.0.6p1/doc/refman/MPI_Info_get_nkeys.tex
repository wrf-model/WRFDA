\startmanpage
\mantitle{MPI{\tt \char`\_}Info{\tt \char`\_}get{\tt \char`\_}nkeys}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Info{\tt \char`\_}get{\tt \char`\_}nkeys}
...
\startarg{nkeys }{number of defined keys (integer)
}
\par
\par
