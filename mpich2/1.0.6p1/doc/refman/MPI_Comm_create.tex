\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}create}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}create}
...
\startarg{group }{group, which is a subset of the group of {\tt comm}  (handle) 
}
\par
\subhead{Output Parameter}
\startarg{comm{\tt \char`\_}out }{new communicator (handle) 
}
\par
...
\nextline
\location{comm{\tt \char`\_}create.c}
\endmanpage
