\startmanpage
\mantitle{MPI{\tt \char`\_}Add{\tt \char`\_}error{\tt \char`\_}code}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Add{\tt \char`\_}error{\tt \char`\_}code}
...
\startarg{errorclass }{Error class to add an error code.
}
\par
\subhead{Output Parameter}
\startarg{errorcode }{New error code for this error class.
}
\par
...
\location{add{\tt \char`\_}error{\tt \char`\_}code.c}
\endmanpage
