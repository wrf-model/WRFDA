\startmanpage
\mantitle{MPI{\tt \char`\_}Info{\tt \char`\_}get{\tt \char`\_}valuelen}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Info{\tt \char`\_}get{\tt \char`\_}valuelen}
...
\startarg{valuelen }{length of value argument (integer)
}
\startarg{flag }{true if key defined, false if not (boolean)
}
\par
\par
...
\location{info{\tt \char`\_}getvallen.c}
\endmanpage
