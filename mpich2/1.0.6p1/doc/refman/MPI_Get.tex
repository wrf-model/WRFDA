\startmanpage
\mantitle{MPI{\tt \char`\_}Get}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Get}
...
\startarg{origin{\tt \char`\_}addr }{Address of the buffer in which to receive the data
}
...
\startarg{target{\tt \char`\_}disp }{displacement from window start to the beginning of the 
