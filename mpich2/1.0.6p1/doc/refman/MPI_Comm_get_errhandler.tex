\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}get{\tt \char`\_}errhandler}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}get{\tt \char`\_}errhandler}
...
\startarg{errhandler }{handler currently associated with communicator (handle) 
}
\par
\par
...
\location{comm{\tt \char`\_}get{\tt \char`\_}errhandler.c}
\endmanpage
