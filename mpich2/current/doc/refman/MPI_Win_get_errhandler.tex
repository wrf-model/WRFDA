\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}get{\tt \char`\_}errhandler}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}get{\tt \char`\_}errhandler}
...
\startarg{win }{window (handle) 
}
\par
\subhead{Output Parameter}
\startarg{errhandler }{error handler currently associated with window (handle) 
}
\par
...
\location{win{\tt \char`\_}get{\tt \char`\_}errhandler.c}
\endmanpage
