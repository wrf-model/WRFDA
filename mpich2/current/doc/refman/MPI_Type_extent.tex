\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}extent}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}extent}
...
\startarg{extent }{datatype extent (integer) 
}
\par
...
\location{type{\tt \char`\_}extent.c}
\endmanpage
