\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}delete{\tt \char`\_}attr}{tex}{10/14/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}delete{\tt \char`\_}attr}
...
\startarg{comm{\tt \char`\_}keyval }{The key value of the deleted attribute (integer) 
}
\par
...
\par
\subhead{See Also}
MPI{\tt \char`\_}Comm{\tt \char`\_}set{\tt \char`\_}attr, MPI{\tt \char`\_}Comm{\tt \char`\_}create{\tt \char`\_}keyval
\nextline
\location{comm{\tt \char`\_}delete{\tt \char`\_}attr.c}
\endmanpage
