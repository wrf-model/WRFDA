\startmanpage
\mantitle{MPI{\tt \char`\_}File{\tt \char`\_}call{\tt \char`\_}errhandler}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}File{\tt \char`\_}call{\tt \char`\_}errhandler}
...
\startarg{fh }{MPI file with error handler (handle) 
}
...
\startarg{MPI{\tt \char`\_}ERR{\tt \char`\_}FILE }{Invalid MPI File handle
}
\location{file{\tt \char`\_}call{\tt \char`\_}errhandler.c}
\endmanpage
