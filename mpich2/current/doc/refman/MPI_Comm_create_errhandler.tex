\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}create{\tt \char`\_}errhandler}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}create{\tt \char`\_}errhandler}
...
\startarg{function }{user defined error handling procedure (function) 
}
\par
...
\location{comm{\tt \char`\_}create{\tt \char`\_}errhandler.c}
\endmanpage
