\startmanpage
\mantitle{MPI{\tt \char`\_}Errhandler{\tt \char`\_}set}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Errhandler{\tt \char`\_}set}
...
\startarg{comm }{communicator to set the error handler for (handle) 
}
\startarg{errhandler }{new MPI error handler for communicator (handle) 
}
\par
...
routine.
The replacement for this routine is {\tt MPI{\tt \char`\_}Comm{\tt \char`\_}set{\tt \char`\_}errhandler}.
\par
...
\par
\subhead{See Also}
 MPI{\tt \char`\_}Comm{\tt \char`\_}set{\tt \char`\_}errhandler, MPI{\tt \char`\_}Errhandler{\tt \char`\_}create, MPI{\tt \char`\_}Comm{\tt \char`\_}create{\tt \char`\_}errhandler
\nextline
\location{errhandler{\tt \char`\_}set.c}
\endmanpage
