\startmanpage
\mantitle{MPI{\tt \char`\_}Finalized}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Finalized}
--- Indicates whether {\tt MPI{\tt \char`\_}Finalize} has been called. 
\subhead{Synopsis}
...
\startarg{flag }{Flag is true if {\tt MPI{\tt \char`\_}Finalize} has been called and false otherwise. 
(logical)
}
\par
