\startmanpage
\mantitle{MPI{\tt \char`\_}File{\tt \char`\_}get{\tt \char`\_}errhandler}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}File{\tt \char`\_}get{\tt \char`\_}errhandler}
...
\startarg{file }{MPI file (handle) 
}
\par
\subhead{Output Parameter}
\startarg{errhandler }{handler currently associated with file (handle) 
}
\par
\par
...
\location{file{\tt \char`\_}get{\tt \char`\_}errhandler.c}
\endmanpage
