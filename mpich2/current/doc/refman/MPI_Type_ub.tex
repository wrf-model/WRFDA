\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}ub}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}ub}
...
\startarg{displacement }{displacement of upper bound from origin, 
in bytes (integer) 
}
\par
