\startmanpage
\mantitle{MPI{\tt \char`\_}Group{\tt \char`\_}size}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Group{\tt \char`\_}size}
...
\startarg{size }{number of processes in the group (integer) 
}
\par
...
\location{group{\tt \char`\_}size.c}
\endmanpage
