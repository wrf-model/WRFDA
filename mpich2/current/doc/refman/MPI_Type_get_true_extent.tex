\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}get{\tt \char`\_}true{\tt \char`\_}extent}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}get{\tt \char`\_}true{\tt \char`\_}extent}
...
\startarg{datatype }{datatype to get information on (handle) 
}
\par
\subhead{Output Parameters}
\startarg{true{\tt \char`\_}lb }{true lower bound of datatype (integer) 
}
\startarg{true{\tt \char`\_}extent }{true size of datatype (integer) 
}
\par
...
\location{type{\tt \char`\_}get{\tt \char`\_}true{\tt \char`\_}extent.c}
\endmanpage
