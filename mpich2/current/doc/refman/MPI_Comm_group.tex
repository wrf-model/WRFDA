\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}group}{tex}{10/14/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}group}
...
\startarg{group }{Group in communicator (handle)
}
\par
\subhead{Notes}
...
\location{comm{\tt \char`\_}group.c}
\endmanpage
