\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}delete{\tt \char`\_}attr}{tex}{10/14/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}delete{\tt \char`\_}attr}
...
\startarg{win }{window from which the attribute is deleted (handle) 
}
...
\location{win{\tt \char`\_}delete{\tt \char`\_}attr.c}
\endmanpage
