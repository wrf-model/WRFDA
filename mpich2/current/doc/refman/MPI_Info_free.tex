\startmanpage
\mantitle{MPI{\tt \char`\_}Info{\tt \char`\_}free}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Info{\tt \char`\_}free}
...
\startarg{info }{info object to be freed (handle)
}
\par
