\startmanpage
\mantitle{MPI{\tt \char`\_}Get{\tt \char`\_}version}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Get{\tt \char`\_}version}
...
\startarg{version }{Version of MPI
}
\startarg{subversion }{Subversion of MPI
}
\par
