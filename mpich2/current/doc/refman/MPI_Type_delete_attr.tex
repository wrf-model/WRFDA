\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}delete{\tt \char`\_}attr}{tex}{10/14/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}delete{\tt \char`\_}attr}
...
\startarg{type }{MPI datatype to which attribute is attached (handle)
}
\startarg{type{\tt \char`\_}keyval }{The key value of the deleted attribute (integer) 
}
\par
...
\location{type{\tt \char`\_}delete{\tt \char`\_}attr.c}
\endmanpage
