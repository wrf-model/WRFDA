\startmanpage
\mantitle{MPI{\tt \char`\_}Rsend{\tt \char`\_}init}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Rsend{\tt \char`\_}init}
...
\startarg{count }{number of elements sent (integer) 
}
...
\par
\subhead{See Also}
 MPI{\tt \char`\_}Start, MPI{\tt \char`\_}Request{\tt \char`\_}free, MPI{\tt \char`\_}Send{\tt \char`\_}init
\nextline
\location{rsend{\tt \char`\_}init.c}
\endmanpage
