\startmanpage
\mantitle{MPI{\tt \char`\_}Cartdim{\tt \char`\_}get}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Cartdim{\tt \char`\_}get}
...
\startarg{ndims }{number of dimensions of the cartesian structure (integer) 
}
\par
...
\location{cartdim{\tt \char`\_}get.c}
\endmanpage
