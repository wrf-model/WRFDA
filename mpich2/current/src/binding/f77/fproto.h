...
extern FORT_DLL_SPEC void FORT_CALL mpi_file_create_errhandler_ ( MPI_File_errhandler_fn*v1, MPI_Fint *v2, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_file_create_errhandler_);
...
extern FORT_DLL_SPEC void FORT_CALL mpi_win_create_errhandler_ ( MPI_Win_errhandler_fn*v1, MPI_Fint *v2, MPI_Fint *ierr ) FUNC_ATTRIBUTES(mpi_win_create_errhandler_);
...
extern FORT_DLL_SPEC void FORT_CALL mpi_comm_dup_fn_ ( MPI_Fint, MPI_Fint*, void*, void**, void**, MPI_Fint*, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_comm_dup_fn_);
extern FORT_DLL_SPEC void FORT_CALL mpi_comm_null_delete_fn_ ( MPI_Fint*, MPI_Fint*, void*, void*, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_comm_null_delete_fn_);
extern FORT_DLL_SPEC void FORT_CALL mpi_comm_null_copy_fn_ ( MPI_Fint*, MPI_Fint*, void*, void*, void*, MPI_Fint *, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_comm_null_copy_fn_);
extern FORT_DLL_SPEC void FORT_CALL mpi_win_dup_fn_ ( MPI_Fint, MPI_Fint*, void*, void**, void**, MPI_Fint*, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_win_dup_fn_);
extern FORT_DLL_SPEC void FORT_CALL mpi_win_null_delete_fn_ ( MPI_Fint*, MPI_Fint*, void*, void*, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_win_null_delete_fn_);
extern FORT_DLL_SPEC void FORT_CALL mpi_win_null_copy_fn_ ( MPI_Fint*, MPI_Fint*, void*, void*, void*, MPI_Fint *, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_win_null_copy_fn_);
extern FORT_DLL_SPEC void FORT_CALL mpi_type_dup_fn_ ( MPI_Fint, MPI_Fint*, void*, void**, void**, MPI_Fint*, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_type_dup_fn_);
extern FORT_DLL_SPEC void FORT_CALL mpi_type_null_delete_fn_ ( MPI_Fint*, MPI_Fint*, void*, void*, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_type_null_delete_fn_);
extern FORT_DLL_SPEC void FORT_CALL mpi_type_null_copy_fn_ ( MPI_Fint*, MPI_Fint*, void*, void*, void*, MPI_Fint *, MPI_Fint * ) FUNC_ATTRIBUTES(mpi_type_null_copy_fn_);
