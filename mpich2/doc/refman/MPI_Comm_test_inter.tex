\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}test{\tt \char`\_}inter}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}test{\tt \char`\_}inter}
...
\startarg{comm }{communicator to test (handle) 
}
\par
\subhead{Output Parameter}
\startarg{flag }{true if this is an inter-communicator(logical) 
}
\par
...
\location{comm{\tt \char`\_}test{\tt \char`\_}inter.c}
\endmanpage
