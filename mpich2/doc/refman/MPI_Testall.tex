\startmanpage
\mantitle{MPI{\tt \char`\_}Testall}{tex}{11/19/2006}
\manname{MPI{\tt \char`\_}Testall}
...
\startarg{count }{lists length (integer) 
}
\startarg{array{\tt \char`\_}of{\tt \char`\_}requests }{array of requests (array of handles) 
}
\par
\subhead{Output Parameters}
\startarg{flag }{True if all requests have completed; false otherwise (logical) 
}
\startarg{array{\tt \char`\_}of{\tt \char`\_}statuses }{array of status objects (array of Status).  May be
