\startmanpage
\mantitle{MPI{\tt \char`\_}Test{\tt \char`\_}cancelled}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Test{\tt \char`\_}cancelled}
...
\startarg{flag }{true if the request was cancelled, false otherwise (logical) 
}
\par
...
\location{test{\tt \char`\_}cancelled.c}
\endmanpage
