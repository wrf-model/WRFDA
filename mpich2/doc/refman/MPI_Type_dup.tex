\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}dup}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}dup}
...
\startarg{type }{datatype (handle) 
}
\par
\subhead{Output Parameter}
\startarg{newtype }{copy of type (handle) 
}
\par
