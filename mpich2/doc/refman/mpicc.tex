...
\startarg{-cc$=$name   }{Use compiler {\tt name} instead of the default choice.  Use
...
This allows a single {\tt mpicc} command to be used with 
multiple compilers.
}
...
The environment variable {\tt MPICH{\tt \char`\_}CC} may be used
