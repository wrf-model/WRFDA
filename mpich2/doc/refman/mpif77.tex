...
\startarg{-f77$=$name   }{Use compiler {\tt name} instead of the default choice.  Use
...
This allows a single {\tt mpif77} command to be used with 
multiple compilers.
}
