\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}get{\tt \char`\_}attr}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}get{\tt \char`\_}attr}
...
\location{comm{\tt \char`\_}get{\tt \char`\_}attr.c}
\endmanpage
