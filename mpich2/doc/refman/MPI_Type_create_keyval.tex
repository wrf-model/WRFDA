\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}create{\tt \char`\_}keyval}{tex}{7/11/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}create{\tt \char`\_}keyval}
...
\startarg{type{\tt \char`\_}copy{\tt \char`\_}attr{\tt \char`\_}fn }{copy callback function for type{\tt \char`\_}keyval (function) 
}
\startarg{type{\tt \char`\_}delete{\tt \char`\_}attr{\tt \char`\_}fn }{delete callback function for type{\tt \char`\_}keyval (function) 
}
\startarg{extra{\tt \char`\_}state }{extra state for callback functions 
}
\par
\subhead{Output Parameter}
\startarg{type{\tt \char`\_}keyval }{key value for future access (integer) 
}
\par
\subhead{Notes}
\par
Default copy and delete functions are available.  These are
\startarg{MPI{\tt \char`\_}TYPE{\tt \char`\_}NULL{\tt \char`\_}COPY{\tt \char`\_}FN   }{empty copy function
}
\startarg{MPI{\tt \char`\_}TYPE{\tt \char`\_}NULL{\tt \char`\_}DELETE{\tt \char`\_}FN }{empty delete function
}
\startarg{MPI{\tt \char`\_}TYPE{\tt \char`\_}DUP{\tt \char`\_}FN         }{simple dup function
}
\par
\par
...
\location{type{\tt \char`\_}create{\tt \char`\_}keyval.c}
\endmanpage
