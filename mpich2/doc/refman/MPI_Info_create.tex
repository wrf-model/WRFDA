\startmanpage
\mantitle{MPI{\tt \char`\_}Info{\tt \char`\_}create}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Info{\tt \char`\_}create}
...
\startarg{info }{info object created (handle)
}
\par
...
\location{info{\tt \char`\_}create.c}
\endmanpage
