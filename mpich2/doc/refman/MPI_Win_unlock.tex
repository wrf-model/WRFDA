\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}unlock}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}unlock}
...
\startarg{rank }{rank of window (nonnegative integer) 
}
...
\par
\subhead{See Also}
 MPI{\tt \char`\_}Win{\tt \char`\_}lock
\nextline
\location{win{\tt \char`\_}unlock.c}
\endmanpage
