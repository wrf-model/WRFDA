\startmanpage
\mantitle{MPI{\tt \char`\_}Keyval{\tt \char`\_}free}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Keyval{\tt \char`\_}free}
...
\startarg{keyval }{Frees the integer key value (integer) 
}
\par
\subhead{Note}
...
routine.
The replacement for this routine is {\tt MPI{\tt \char`\_}Comm{\tt \char`\_}free{\tt \char`\_}keyval}.
\par
...
\par
\subhead{See Also}
 MPI{\tt \char`\_}Keyval{\tt \char`\_}create, MPI{\tt \char`\_}Comm{\tt \char`\_}free{\tt \char`\_}keyval
\nextline
\location{keyval{\tt \char`\_}free.c}
\endmanpage
