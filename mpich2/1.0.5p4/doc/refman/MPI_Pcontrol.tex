\startmanpage
\mantitle{MPI{\tt \char`\_}Pcontrol}{tex}{12/1/2006}
\manname{MPI{\tt \char`\_}Pcontrol}
--- Controls profiling 
\subhead{Synopsis}
...
\startarg{level }{Profiling level 
}
\startarg{... }{other arguments (see notes)
}
\par
\subhead{Notes}
This routine provides a common interface for profiling control.  The
interpretation of {\tt level} and any other arguments is left to the
