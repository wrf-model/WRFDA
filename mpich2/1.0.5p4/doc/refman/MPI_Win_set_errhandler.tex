\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}set{\tt \char`\_}errhandler}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}set{\tt \char`\_}errhandler}
...
\startarg{errhandler }{new error handler for window (handle) 
}
\par
\par
...
\location{win{\tt \char`\_}set{\tt \char`\_}errhandler.c}
\endmanpage
