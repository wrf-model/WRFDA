\startmanpage
\mantitle{MPI{\tt \char`\_}Abort}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Abort}
...
\startarg{comm }{communicator of tasks to abort 
}
\startarg{errorcode }{error code to return to invoking environment 
}
\par
\subhead{Notes}
