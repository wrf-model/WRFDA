\startmanpage
\mantitle{MPI{\tt \char`\_}Comm{\tt \char`\_}rank}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Comm{\tt \char`\_}rank}
...
\subhead{Input Argument}
\startarg{comm }{communicator (handle) 
}
\par
\subhead{Output Argument}
\startarg{rank }{rank of the calling process in the group of {\tt comm}  (integer) 
}
\par
