\startmanpage
\mantitle{MPI{\tt \char`\_}Attr{\tt \char`\_}delete}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Attr{\tt \char`\_}delete}
...
\startarg{keyval }{The key value of the deleted attribute (integer) 
}
\par
...
routine.
The replacement for this routine is {\tt MPI{\tt \char`\_}Comm{\tt \char`\_}delete{\tt \char`\_}attr}.
\par
...
\location{attr{\tt \char`\_}delete.c}
\endmanpage
