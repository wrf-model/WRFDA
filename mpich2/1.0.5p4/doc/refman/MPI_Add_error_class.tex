\startmanpage
\mantitle{MPI{\tt \char`\_}Add{\tt \char`\_}error{\tt \char`\_}class}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Add{\tt \char`\_}error{\tt \char`\_}class}
...
\startarg{errorclass }{New error class
}
\par
...
\location{add{\tt \char`\_}error{\tt \char`\_}class.c}
\endmanpage
