\startmanpage
\mantitle{MPI{\tt \char`\_}Group{\tt \char`\_}union}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Group{\tt \char`\_}union}
...
\startarg{newgroup }{union group (handle) 
}
\par
...
\nextline
\location{group{\tt \char`\_}union.c}
\endmanpage
