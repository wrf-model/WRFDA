\startmanpage
\mantitle{MPI{\tt \char`\_}Group{\tt \char`\_}rank}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Group{\tt \char`\_}rank}
...
\startarg{rank }{rank of the calling process in group, or {\tt MPI{\tt \char`\_}UNDEFINED}  if the 
...
\location{group{\tt \char`\_}rank.c}
\endmanpage
