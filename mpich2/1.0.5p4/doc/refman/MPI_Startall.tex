\startmanpage
\mantitle{MPI{\tt \char`\_}Startall}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Startall}
...
\startarg{array{\tt \char`\_}of{\tt \char`\_}requests }{array of requests (array of handle) 
}
\par
\subhead{Notes}
\par
