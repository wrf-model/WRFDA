\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}lb}{tex}{12/9/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}lb}
...
\startarg{displacement }{displacement of lower bound from origin, 
in bytes (integer) 
}
\par
...
routine.
The replacement for this routine is {\tt MPI{\tt \char`\_}Type{\tt \char`\_}Get{\tt \char`\_}extent}.
\par
