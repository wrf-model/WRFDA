\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}create{\tt \char`\_}resized}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}create{\tt \char`\_}resized}
...
\startarg{oldtype }{input datatype (handle) 
}
\startarg{lb }{new lower bound of datatype (integer) 
}
\startarg{extent }{new extent of datatype (integer) 
}
\par
\subhead{Output Parameter}
\startarg{newtype }{output datatype (handle) 
}
\par
...
\location{type{\tt \char`\_}create{\tt \char`\_}resized.c}
\endmanpage
