\startmanpage
\mantitle{MPI{\tt \char`\_}Type{\tt \char`\_}hindexed}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Type{\tt \char`\_}hindexed}
...
\startarg{indices }{byte displacement of each block (array of MPI{\tt \char`\_}Aint) 
}
...
\location{type{\tt \char`\_}hindexed.c}
\endmanpage
