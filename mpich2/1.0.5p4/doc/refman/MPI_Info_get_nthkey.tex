\startmanpage
\mantitle{MPI{\tt \char`\_}Info{\tt \char`\_}get{\tt \char`\_}nthkey}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Info{\tt \char`\_}get{\tt \char`\_}nthkey}
...
\startarg{n }{key number (integer)
}
\par
\subhead{Output Parameters}
\startarg{keys }{key (string).  The maximum number of characters is {\tt MPI{\tt \char`\_}MAX{\tt \char`\_}INFO{\tt \char`\_}KEY}.
}
\par
\par
...
\location{info{\tt \char`\_}getnth.c}
\endmanpage
