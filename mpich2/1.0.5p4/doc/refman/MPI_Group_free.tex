\startmanpage
\mantitle{MPI{\tt \char`\_}Group{\tt \char`\_}free}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Group{\tt \char`\_}free}
--- Frees a group 
\subhead{Synopsis}
...
\startarg{group }{group to free (handle) 
}
\par
\subhead{Notes}
...
\location{group{\tt \char`\_}free.c}
\endmanpage
