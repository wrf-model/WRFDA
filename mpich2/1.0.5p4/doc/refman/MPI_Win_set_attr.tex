\startmanpage
\mantitle{MPI{\tt \char`\_}Win{\tt \char`\_}set{\tt \char`\_}attr}{tex}{10/14/2006}
\manname{MPI{\tt \char`\_}Win{\tt \char`\_}set{\tt \char`\_}attr}
...
\startarg{win }{MPI window object to which attribute will be attached (handle) 
}
\startarg{keyval }{key value, as returned by  {\tt MPI{\tt \char`\_}Win{\tt \char`\_}create{\tt \char`\_}keyval} (integer) 
}
...
\location{win{\tt \char`\_}set{\tt \char`\_}attr.c}
\endmanpage
