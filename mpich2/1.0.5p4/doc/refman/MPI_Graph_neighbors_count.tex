\startmanpage
\mantitle{MPI{\tt \char`\_}Graph{\tt \char`\_}neighbors{\tt \char`\_}count}{tex}{5/8/2006}
\manname{MPI{\tt \char`\_}Graph{\tt \char`\_}neighbors{\tt \char`\_}count}
...
\startarg{rank }{rank of process in group of {\tt comm} (integer) 
}
\par
\subhead{Output Parameter}
\startarg{nneighbors }{number of neighbors of specified process (integer) 
}
\par
