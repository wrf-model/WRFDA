...
BENCH_DECL(comp36)
BENCH_DECL(comp37)
BENCH_DECL(comp37_calc_p_rho_phi)
BENCH_DECL(comp37_a_diagnose_w)
BENCH_DECL(comp37_a_calc_p_rho_phi)
BENCH_DECL(comp38)
BENCH_DECL(comp39)
BENCH_DECL(comp40)
BENCH_DECL(comp41)
...
BENCH_DECL(comp68)
BENCH_DECL(comp69)
BENCH_DECL(comp70_relax_bdy_dry)
BENCH_DECL(comp70_rk_addtend_dry)
BENCH_DECL(comp70_spec_bdy_dry)
BENCH_DECL(comp70_small_step_prep)
BENCH_DECL(comp70_calc_p_rho)
BENCH_DECL(comp70_calc_coef_w)
BENCH_DECL(comp71)
BENCH_DECL(comp72)
BENCH_DECL(comp73)
BENCH_DECL(comp74)
...
BENCH_DECL(comp84)
BENCH_DECL(comp85)
BENCH_DECL(comp85_a_advance_mu_t)
BENCH_DECL(comp86)
BENCH_DECL(comp87)
BENCH_DECL(comp88)
BENCH_DECL(comp89)
...
BENCH_DECL(comp97)
BENCH_DECL(comp98)
BENCH_DECL(comp98_a_small_step_prep)
BENCH_DECL(comp99)
BENCH_DECL(comp100)
BENCH_DECL(comp101)
BENCH_DECL(comp102)
...
BENCH_DECL(comp110)
BENCH_DECL(comp111)
BENCH_DECL(comp_a_rk_tendency1)
BENCH_DECL(comp_a_surface_drag)
BENCH_DECL(comp_a_rk_tendency2)
BENCH_DECL(comp113)
BENCH_DECL(comp114)
BENCH_DECL(comp115)
BENCH_DECL(comp116)
...
BENCH_DECL(comp_moist_physics_prep_tim)
BENCH_DECL(comp_a_moist_physics_finish_tim)
BENCH_DECL(comp_a_lscond_tim)
BENCH_DECL(comp_a_moist_physics_prep_tim)
...
BENCH_DECL(compstore_rk_step_prep_tim)
BENCH_DECL(comprestore_rk_step_prep_tim)
#else
#define SOLVE_START
#define SOLVE_END
#define BENCH_INIT(A)
