#!/bin/ksh
# Test version for SX6 vectorisation
...
usage(){
  ...
  echo "  DATAIN  	../data "
  echo "  DATART	../rtcoef_rttov7"
  echo "  REF_TEST	../reftest_sx6"
  echo "  TEST		../test_sx6 "
  echo
}
if [ $# -lt 9 ]
...
echo  "full gradient==1 or radiance output ==2:  ${NPROF}"
...
1               , forward model only == 0, full gradient==1, radiance output ==2
...
sed -f sed.cmd print.dat > ${TEST}/tstrad_sx6_${TEST_NUMBER}.lst
${DIFF} ${REF_TEST}/tstrad_sx6_${TEST_NUMBER}.lst ${TEST}/tstrad_sx6_${TEST_NUMBER}.lst > ${TEST}/tstrad_sx6_${TEST_NUMBER}.diff
