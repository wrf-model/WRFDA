module da_tools
   ...
   use da_control, only : pi, gravity, gas_constant, ims, ime, jms,jme, &
      ...
      trace_use_dull, trace_use, coarse_ds, coarse_ix, &
      coarse_jy, c2, cone_factor, earth_radius, dsm, map_projection, &
      psi1, pole, start_x, phic, start_y, xlonc, ycntr, obs_qc_pointer, &
      fg_format, fg_format_wrf_arw_regional,fg_format_wrf_nmm_regional, &
      fg_format_wrf_arw_global, fg_format_kma_global, &
      ...
      t_kelvin, trace_use_frequent, jds, jde, rad_to_deg, deg_to_rad
