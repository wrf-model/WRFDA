...
# include files to enable this feature prior to running configure_new.  
...
# files to enable this feature prior to running configure_new.
...
while ( <CONFIGURE_PREAMBLE> ) {
  ...
  if ( $sw_crtm_path ) {
    ...
    $_ =~ s:CONFIGURE_CRTM_INC:-I$sw_crtm_path/src: ;
  } else {
...
print CONFIGURE_WRF "#\n";
print CONFIGURE_WRF "# This file was automatically generated by the configure_new script in the\n";
