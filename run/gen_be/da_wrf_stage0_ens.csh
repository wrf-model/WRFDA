...
#---------------------------------------------------------------
 ...
 setenv WRF_DIR /ocotillo/users/dmbarker/code_development/wrf3dvar 
 setenv DAT_DIR /ocotillo1/dmbarker/data/conus/enkf_input

 setenv RUN_DIR /ocotillo1/dmbarker/data/conus/gen_be
 mkdir -p $RUN_DIR
 
 set BE_TYPE =  2         # 1: NMC(Default),  2: ENS 
 set MEMBER  =  56        # (note) if BE_TYPE = 1, MEMBER should be 1
...
#set date
 set START_BE_DATE = 2003-01-01_06:00:00
 set END_BE_DATE   = 2003-01-11_00:00:00
...
cd $RUN_DIR
ln -sf $DAT_DIR/wrfout_d01_2003-01-01_06:00:00_1 wrf_3dvar_input
