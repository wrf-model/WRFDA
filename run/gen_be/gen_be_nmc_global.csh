...
setenv EXPT 2004-12.T213.glat
setenv WRFVAR_DIR /tara/dmbarker/wrfvar 
setenv DAT_DIR /tara/dmbarker/kma_stats/${EXPT}
setenv RUN_DIR /tara2/dmbarker/kma_stats
...
if ( ! $?GAUSSIAN_LATS ) setenv GAUSSIAN_LATS .true.     # Set if Gaussian latitudes used.
...
if ( ! $?RESOLUTION_KM ) setenv RESOLUTION_KM 30         # Hard-wired for now (only used for regional)
