...
if $NL_VAR4D_LBC; then
   export BDYOUT_TL=$FC_DIR/$DATE/wrfbdy_tl01    # wrfvar boundaries input.
fi
if $NL_VAR4D; then
...
if $NL_VAR4D; then
   ...
   ln -fs ad/wrfbdy_ad01  $WORK_DIR/wrfbdy_ad01
   ...
   ln -fs $WORK_DIR/wrfbdy_d01 tl/wrfbdy_d01
   if $NL_VAR4D_LBC; then
      ln -fs $WORK_DIR/wrfbdy_tl01 tl/wrfbdy_d01
   fi
