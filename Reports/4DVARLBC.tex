...
Case 1: Single observation far away from the boundary. see Figure ~\ref{fig:center_obs_0h}
\\*
Single observation experiment is a good tool to investigate the impact of data assimilation.

\begin{figure}[htp]
\begin{center}
\subfigure[Without LBC control]{
\includegraphics[width=0.45\textwidth, viewport=50 100 600 730, clip]{center}}
\subfigure[With LBC control]{
\includegraphics[width=0.45\textwidth, viewport=50 100 600 730, clip]{center_lbc}}
\end{center}
\caption{0-hour 500 hPa T increment respond to a 6th hour single T observation at 500 hPa, the red cross is the location of the T observation at 6th hour}\label{fig:center_obs_0h}
\end{figure}
%\hspace{0.3in}
\begin{figure}[htp]
\begin{center}
\subfigure[Without LBC control]{
\includegraphics[angle=90, width=0.9\textwidth, viewport=220 50 580 650, clip]{center_6h}}
\subfigure[With LBC control]{
\includegraphics[angle=90, width=0.9\textwidth, viewport=180 50 580 650, clip]{center_lbc_6h}}
\end{center}
\caption{0-6 hour 500 hPa T increment respond to a 6th hour single T observation at 500 hPa.}\label{fig:center_obs_6h}
\end{figure}

Case 2: Single observation close to the boundary. 
\\*
\begin{figure}[htp]
\begin{center}
\subfigure[Without LBC control]{
\includegraphics[width=0.45\textwidth, viewport=50 100 600 730, clip]{boundary}}
\subfigure[With LBC control]{
\includegraphics[width=0.45\textwidth, viewport=50 100 600 730, clip]{boundary_lbc}}
\end{center}
\caption{0-hour 500 hPa T increment respond to a 6th hour single T observation at 500 hPa, the red cross is the location of the T observation at 6th hour}\label{fig:boundary_obs_0h}
\end{figure}

\begin{figure}[htp]
\begin{center}
\subfigure[Without LBC control]{
\includegraphics[angle=90, width=0.9\textwidth, viewport=220 50 580 650, clip]{boundary_6h}}
\subfigure[With LBC control]{
\includegraphics[angle=90, width=0.9\textwidth, viewport=180 50 580 650, clip]{boundary_lbc_6h}}
\end{center}
\caption{0-6 hour 500 hPa T increment respond to a 6th hour single T observation at 500 hPa.}\label{fig:boundary_obs_6h}
\end{figure}
%
\newpage
