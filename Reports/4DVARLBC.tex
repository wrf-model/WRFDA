...
Case 1: Single observation far away from the boundary
\begin{figure}[htp]
\begin{center}
\subfigure[Without LBC control]{
\includegraphics[width=0.45\textwidth, viewport=50 200 600 900, clip]{center}}
%\caption{{\bf Center obs. without LBC control }}
%\label{default}
%\centering
\subfigure[With LBC control]{
\includegraphics[width=0.45\textwidth, viewport=50 200 600 900, clip]{center_lbc}}
\end{center}
\caption{{\bf Center obs. with LBC control }}
%\label{default}
\end{figure}
%\hspace{0.3in}
