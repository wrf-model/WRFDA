...
\begin{itemize}
	...
	\item Not sure if the observation processing for 4DVAR mode is correct ?
	...
	\item Adopt gradient check for GSI-based WRF 4DVAR. \pause
	\item Adopt digital filter as a weak constrain for GSI-based WRF 4DVAR.
\end{itemize}
}
