...
Sincere thanks to Dr. Ricardo Todling who helped us to kick off the project.
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_0.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_6.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_12.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_18.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_24.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_30.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_36.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_42.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.35, trim=0 220 25 80, clip]{Profile_RMSE_48.pdf}
\end{center}
}
...
\frametitle{Summary}
\begin{itemize}
	\item The basic GSI/WRF 4DVAR system was developed with minimum codes modification.
...
\begin{itemize}
	...
	\item The observation processing for 4DVAR mode is still black box for me, need to be investigated. \pause
