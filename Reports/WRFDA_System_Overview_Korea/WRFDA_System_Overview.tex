...
\author[Zhang and Huang, , SNU, April 2012]{Xin Zhang \and Xiang-Yu Huang}

\date{6th East Asia WRF Tutorial, SNU
  ~\\
  ~\\
  ~\\
  ~\\
...
\begin{itemize}
	...
	\item 42 executables should be generated under var/build directory
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item NetCDF library should be re-install with appropriate compiler and option. \pause
        \item V3.4 configure is able to produce configure.wrf for PGI and G95. \pause
