...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\myabstract}{The capability of the precipitation data assimilation is added to the data assimilation system for Weather Research and Forecasting model using four-dimensional variational data assimilation approach. The precipitation data used in this study is derived from National Center for Environmental Prediction(NCEP) Stage IV multi-sensor (radar and gauges) precipitation analyses.
Four experiments over a 1-month period in June 2010 are conducted to assess the impact of precipitation assimilation on analyses and short-range forecasts, meanwhile, the results of a single weather event in this period is presented to further investigate the impact. 
...
which is based on the multi-sensor hourly/6-hourly NCEP Stage III analyses produced by the 12 River Forecast Centers (RFCs) in continental United States (CONUS) and benefits from the RFCsÕ manual quality control step. 
...
It should be noticed that assimilation of precipitation observation is different from  conventional data assimilation in the following ways: Firstly, rain gauge observations are total amount, which can be include large-scale and/or convective precipitation in model simulation. Secondly,  precipitation is not included in the definition of the control variable, but the assimilation of precipitation observations will have feedback to all the control variables via the adjoint of physics package. Moreover, the model precipitation is an integral quantity and the same duration of model precipitation should be compared to the observations \citep{Zupanski,Zou}.
...
\section{Conclusion}
The impact of assimilating precipitation data on analyses and short-range forecasts has been investigated using WRFDA 4D-Var. Four experiments over 1-month period in June 2010 have been conducted: CONTROLÑ without assimilation; GTS Ñ assimilation of conventional data only; RAIN Ñ assimilation of precipitation data only; and GTS+RAINÑ assimilation of both conventional and precipitation data.  The forecasts are verified against upper air sounding observations and NCEP Stage IV. 

On average, assimilating precipitation data together with conventional data improves the vertical profile of wind speed, temperature and relative humidity compared to only assimilating conventional or precipitation data, especially for the low level relative humidity. For the impact on precipitation forecasts, the results show that precipitation assimilation using WRFDA 4D-Var succeeded in bringing the model precipitation closer to the observations through the changes in temperature, moisture and wind imposed in the analyses.
...
\begin{figure}  
  \noindent\includegraphics[width=19pc,angle=0]{wind_00.eps}\\
  \noindent\includegraphics[width=19pc,angle=0]{wind_12.eps}\\
  \noindent\includegraphics[width=19pc,angle=0]{wind_24.eps}\\  
...
\begin{figure}
  \noindent\includegraphics[width=19pc,angle=0]{tmp_00.eps}\\
  \noindent\includegraphics[width=19pc,angle=0]{tmp_12.eps}\\
  \noindent\includegraphics[width=19pc,angle=0]{tmp_24.eps}\\  
   \caption{Same as Figure 1 but for temperature.}
   \label{f2}
\end{figure}

\begin{figure}
  \noindent\includegraphics[width=19pc,angle=0]{rh_00.eps}\\
  \noindent\includegraphics[width=19pc,angle=0]{rh_12.eps}\\
  \noindent\includegraphics[width=19pc,angle=0]{rh_24.eps}\\  
   \caption{Same as Figure 1 but for relative humidity. }
 \label{f3}
\end{figure}

 \begin{figure}[!ht]\centering 
  \noindent\includegraphics[width=27pc,angle=0]{GSS_06.eps}\\
  \noindent\includegraphics[width=27pc,angle=0]{GSS_12.eps}\\ 
...
\begin{figure}[!ht]\centering
  ...
  \noindent\includegraphics[width=27pc,angle=0]{GSS_18.eps}\\
  \noindent\includegraphics[width=27pc,angle=0]{GSS_24.eps}\\   
   \caption{continued}
   \label{f4}
\end{figure}
...
\end{figure}
  ...
  \begin{figure}
  \noindent\includegraphics[width=33pc,angle=0]{GSS_24_sensitive_error.eps}\\
...
\end{figure}
   ...
   \begin{figure}
  \noindent\includegraphics[width=29pc,angle=0]{gss_singlecase.eps}\\
