...
which is based on the multi-sensor (radar and gauges) hourly/6-hourly NCEP Stage III analyses produced by the 12 River Forecast Centers (RFCs) in continental United States (CONUS) and benefits from the RFCsÕ manual quality control step. 
