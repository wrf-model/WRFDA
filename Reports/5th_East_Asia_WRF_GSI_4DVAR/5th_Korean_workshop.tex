...
\title[Progress and evaluation of WRF/GSI 4D-var]{Progress and preliminary evaluation of upgraded WRF 4D-Var and \\GSI-based WRF 4D-Var}
\author[Zhang et al.]{Xin Zhang \and Xiang-Yu Huang \\
\and Ning Pan \and Qiang Cheng \and Junmei Ban}

\date{~\\
~\\
~\\\tiny{5th East Asia WRF Workshop, Busan, S. Korea}\\
  ~\\
  ~\\
  ~\\
...
\frame{
\frametitle{\small Know issues of WRF 4D-Var V3.2}
\begin{itemize}
...
\begin{itemize}
	...
	\item WRFPLUS V3.3 can be used as a standalone tool or as a component in 4D-Var system.
\end{itemize}
}
...
WRFPLUS includes WRF NL, AD and TL model and they are used as a subroutine in WRF 4D-Var V3.3, other than being called via shell scripts in V3.2.
~\\
~\\
\setbeamercolor{postit}{fg=black, bg=yellow}
...
\frame{
\frametitle{\small Parallel run using all processors}
...
\frame{
\frametitle{\small Additional experiments design\\Observation close to boundary}
...
\begin{itemize}
	\item The single executable WRF 4DVar system was developed and has showed promising performance. \pause 
...
\begin{itemize}
	\item The development of GSI-based WRF 4DVAR is based on Boulder's version as of February 2011\pause
...
\end{comment}
%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{GSI/WRF 4DVAR System Validation}
...
\frame{
\frametitle{\small Averaged Bias and RMSE of surface forecasts}
\begin{center}
\includegraphics[scale=0.27, trim=0 100 0 60, clip]{Bias_surface_all_var.pdf}
\includegraphics[scale=0.27, trim=0 100 0 60, clip]{RMSE_surface_all_var.pdf}
\end{center}
}

\frame{
\frametitle{\small Averaged Bias and RMSE of upper level U component}
\begin{center}
%\includegraphics[scale=0.27, trim=0 100 0 60, clip]{Bias_upplevel_UGRD.pdf}
\includegraphics[scale=0.27, trim=0 100 0 60, clip]{RMSE_upplevel_UGRD.pdf}
\end{center}
}

\frame{
\frametitle{\small Averaged Bias and RMSE of upper level V component}
\begin{center}
%\includegraphics[scale=0.27, trim=0 100 0 60, clip]{Bias_upplevel_VGRD.pdf}%
\includegraphics[scale=0.27, trim=0 100 0 60, clip]{RMSE_upplevel_VGRD.pdf}
\end{center}
}

\frame{
\frametitle{\small Averaged Bias and RMSE of upper level Temperature}
\begin{center}
%\includegraphics[scale=0.27, trim=0 100 0 60, clip]{Bias_upplevel_TMP.pdf}
\includegraphics[scale=0.27, trim=0 100 0 60, clip]{RMSE_upplevel_TMP.pdf}
\end{center}
}

\frame{
\frametitle{\small Averaged Bias and RMSE of upper level Moisture}
\begin{center}
...
\frametitle{\small Under development}
\begin{itemize}
	\item Add simplified physics packages into WRFPLUS: surface drag(\alert{done}), large scale condensation, a simplified cumulus scheme, as well as a radiation scheme. \pause
