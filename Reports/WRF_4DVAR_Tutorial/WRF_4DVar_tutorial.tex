...
\title[WRF 4D-Var V3.3, WRFDA Tutorial]{\small{WRF Four-dimensional variational data assimilation \\Tutorial for V3.3}}
...
\begin{itemize}
	...
	\item Mac with GFORTRAN compiler V4.4.0  
\end{itemize}
}
...
\begin{center}
\includegraphics[scale=0.50,trim=1 200 1 180, clip]{obs_usage0}
\end{center}
}
...
\item Modify namelist.input for radiance data :
\tiny
\begin{verbatim}
&wrfvar4
	use_amsuaobs=true,
...
\begin{center}
\includegraphics[scale=0.30,trim=1 200 1 180, clip]{obs_usage}
\end{center}
\pause
\begin{itemize}
	\item link/copy prepbufr data at 00Z as $ob01.bufr$
	\item link/copy prepbufr data at 06Z as $ob02.bufr$\pause
	\item link/copy amsua data at 00Z as $amsua01.bufr$
	\item link/copy amsua data at 06Z as $amsua02.bufr$
	\item \dots
\end{itemize}
}
...
\begin{itemize}
	\item Solution: It might be a bug, under investigation. Please try with another compiler.
\end{itemize}
