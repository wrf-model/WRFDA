...
\title[WRF 4D-Var V3.5, WRFDA Tutorial]{\small{WRF Four-dimensional variational data assimilation system\\Tutorial for V3.5}}
\author[Zhang and Huang, Boulder, July 2013]{Xin Zhang \and Xiang-Yu Huang}

\date{\tiny{Presented in July 2013, WRFDA Tutorial} \\
  ~\\
  ~\\
  ~\\
  ~\\
...
\begin{itemize}
	...
	\item download the WRFPLUSV3 codes  and the patch from :\\
		...
		{\tiny\url{http://www.mmm.ucar.edu/wrf/users/wrfda/known-prob_V3_5.html}}\pause
	\item enter into WRFDA/var/test/4dvar \pause
	\item get the test dataset from :\\
		{\tiny\url{ftp://ftp.ucar.edu/pub/mmm/xinzhang/WRF4DVar_V3.5_Tutorial/2008020521}}\pause
...
We have tested the WRF 4D-Var V3.5 on following systems:
\begin{itemize}
...
\tiny{\url{http://www.mmm.ucar.edu/wrf/users/wrfda/Docs/user_guide_V3.5/users_guide_chap6.htm#_Radiance_Data_Assimilations}} \\
~\\
