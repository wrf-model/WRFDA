...
C-----------------------------------------------------------------------
      ...
      CHARACTER*4 BUFR                                                  
      CHARACTER*4 TEMP(5000,32)                                                  
      DIMENSION   IEC0(2)
      EQUIVALENCE (SEC0,IEC0)
      EQUIVALENCE (TEMP,MBAY)
...
1     MBIT = 0                                                          
      SEC0 = ' '                                                        
      IMSG = 8/NBYTW+1                                                  
C      READ(LUNIT,ERR=902,END=100) SEC0,(MBAY(I,LUN),I=IMSG,LMSG(SEC0))  
      READ(LUNIT,ERR=902,END=100) SEC0,(TEMP(I,LUN),I=IMSG,LMSG(SEC0))  
