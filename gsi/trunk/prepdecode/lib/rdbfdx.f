...
C-----------------------------------------------------------------------
     ...
     .                LD30(10),DXSTR(10)                                
      ...
      CHARACTER*4 TEMP(5000)
      DIMENSION     MBAY(5000),LDXBD(10),LDXBE(10)                      
      EQUIVALENCE   (MBAY(1),MOCT(1), TEMP(1))                                   
      LOGICAL       DIGIT
...
1     DO I=1,5000                                                       
      ...
      IMSG = 8/NBYTW+1                                                  
C      READ(LUNIT,ERR=900,END=2) SEC0,(MBAY(I),I=IMSG,LMSG(SEC0))        
      READ(LUNIT,ERR=900,END=2) SEC0,(TEMP(I),I=IMSG,LMSG(SEC0))        
      IDX = IDX+1                                                       
...
C  -------------------------------------------------------------------- 
      ...
      IF(IUPM(MOCT(I1+9),8).NE.11) THEN                                 
         REWIND LUNIT                                                   
         DO NDX=1,IDX-1                                                 
C         READ(LUNIT,ERR=910,END=910) SEC0,(MBAY(I),I=IMSG,LMSG(SEC0))   
         READ(LUNIT,ERR=910,END=910) SEC0,(TEMP(I),I=IMSG,LMSG(SEC0))   
         ENDDO                                                          
         CALL MAKESTAB                                                  
         RETURN                                                         
      ENDIF                                                             
