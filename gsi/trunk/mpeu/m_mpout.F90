...
!JFM I removed the final semi colons which casued problems for the ifort compiler
      interface mpout_open;  module procedure open_
      end interface
      interface mpout_close; module procedure close_
      end interface
      interface mpout_sync;  module procedure sync_
      end interface
      interface mpout_flush; module procedure flush_
      end interface
      interface mpout_ison;  module procedure ison_
      end interface
