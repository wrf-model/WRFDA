...
#                          Fortran optimization level 4, C optimization level 3)
#   The -i8 option does not work becasue of iupm.f - JFM
...
/usr/bin/cpp -P -traditional -DSUPERSIZE bufrlib.PRM bufrlib.prm
