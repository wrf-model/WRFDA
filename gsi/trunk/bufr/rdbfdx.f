...
901   CALL BORT('BUFRLIB: RDBFDX - UNEXPECTED DICTIONARY MESSAGE '//
     ...
     . 'KNOWN)')
902   call mpi_comm_rank(mpi_comm_world,mype,ierror)             !JFM
      write(110+mype,*)'DXCMP',DXCMP,I3                          !JFM
      write(110+mype,*)'DXSTR',DXSTR(IDXS),i3                    !JFM
      write(110+mype,*)'MOCT ',MOCT(I3+8:I3+8+NXSTR(IDXS)-1),i3  !JFM
      write(110+mype,*)i3,idxs,NXSTR(IDXS),LUNIT                 !JFM
      write(110+mype,*)'mbay',(I3+8)/4,mbay((I3+8)/4)            !JFM
      CALL BORT('BUFRLIB: RDBFDX - UNEXPECTED DICTIONARY MESSAGE '//
     . 'CONTENTS')
