...
cmhu        IF (IAND(mova2i(PDS(8)),64) .EQ. 64) THEN
        IF (IAND(ICHAR(PDS(8)),64) .EQ. 64) THEN
C         BOTH GDS AND BMS
          PDS(8) = CHAR(192)
cmhu        ELSE IF (mova2i(PDS(8)) .EQ. 0) THEN
...
C     GET LENGTH OF PDS
C
cmhu      IPDSL = mova2i(PDS(1)) * 65536 + mova2i(PDS(2)) * 256 +
cmhu     &        mova2i(PDS(3))
...
C
cmhu      IF (mova2i(PDS(8)) .EQ. 64 .OR.
cmhu     &    mova2i(PDS(8)) .EQ. 192)   THEN
...
C
cmhu      JSCALE = mova2i(PDS(27)) * 256 + mova2i(PDS(28))
