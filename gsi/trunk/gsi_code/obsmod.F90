...
! Declare types
  ...
  type ps_ob_type
     ...
     integer(i_kind) :: pk1           !  from W Wu adjusting obs error by perturbed obs
  ...
  type t_ob_type
     ...
     integer(i_kind) :: tk1           !  from W Wu adjusting obs error by perturbed obs
  ...
  type w_ob_type
     ...
     integer(i_kind) :: ij(8)         !  horizontal locations
     logical         :: luse          !  flag indicating if ob is used in pen.
     integer(i_kind) :: wk1           !  from W Wu adjusting obs error by perturbed obs
  ...
  type q_ob_type
     ...
     integer(i_kind) :: ij(8)         !  horizontal locations
     logical         :: luse          !  flag indicating if ob is used in pen.
     integer(i_kind) :: qk1           !  from W Wu adjusting obs error by perturbed obs
