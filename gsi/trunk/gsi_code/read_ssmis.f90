...
!                 (3) - snow percentage
        ...
        call deter_sfc(dlat+0.7,dlon+0.7,isflg_1,sfcpct_1,sstx_1)
        call deter_sfc(dlat+0.7,dlon-0.7,isflg_2,sfcpct_2,sstx_2)
        call deter_sfc(dlat-0.7,dlon+0.7,isflg_3,sfcpct_3,sstx_3)
        call deter_sfc(dlat-0.7,dlon-0.7,isflg_4,sfcpct_4,sstx_4)
