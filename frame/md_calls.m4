...
SUBROUTINE wrf_$1_$2_$6_$3$4_$5 ( DataHandle,Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') Data, &
                                  ifelse($4,char,,`Count, ifelse($1,get,`Outcount,')') Status )
...
ifelse($4,char,`CHARACTER*(*)  :: Data', `ifelse($3,real8,real(kind=8),$3)  :: Data ifelse($5,arr,(*),)')
...
ifelse($3,real,`real(kind=4) :: loc_data ifelse($5,arr,(Count),)')
...
ifelse($3,real,`ifelse($1,put,`loc_data ifelse($5,arr,(1:Count),) = Data ifelse($5,arr,(1:Count),)')')
...
IF ( Hndl .GT. -1 ) THEN
  IF ( multi_files( io_form ) .OR. .NOT. (for_out .AND. use_output_servers()) ) THEN
    SELECT CASE ( use_package( io_form ) )
#ifdef INTERNAL_IO
      CASE ( IO_INTERNAL )
        CALL int_$1_$2_$6_$3$4 ( Hndl, Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') &
                         ifelse($3,real,`loc_data', `Data'), &
                         ifelse($4,char,,`locCount, ifelse($1,get,`Outcount,')') Status )
#endif
#ifdef NETCDF
      CASE ( IO_NETCDF   )
        IF ( multi_files(io_form) .OR.  wrf_dm_on_monitor() ) THEN
           CALL ext_ncd_$1_$2_$6_$3$4 ( Hndl, Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') &
                                 ifelse($3,real,`loc_data', `Data'), &
                                 ifelse($4,char,,`locCount, ifelse($1,get,`Outcount,')') Status )
        ENDIF
        IF ( .NOT. multi_files(io_form) ) THEN
          ifelse($1,get,ifelse($3,integer,`CALL wrf_dm_bcast_bytes( locCount, IWORDSIZE )'))
          ifelse($1,get,ifelse($3,integer,`CALL wrf_dm_bcast_bytes( ifelse($3,real,`loc_data', `Data'), IWORDSIZE*locCount )'))
          ifelse($1,get,ifelse($3,real,   `CALL wrf_dm_bcast_bytes( locCount, IWORDSIZE )'))
          ifelse($1,get,ifelse($3,real,   `CALL wrf_dm_bcast_bytes( ifelse($3,real,`loc_data', `Data'), RWORDSIZE*locCount )'))
          ifelse($1,get,ifelse($3,logical,`CALL wrf_dm_bcast_bytes( locCount, IWORDSIZE )'))
          ifelse($1,get,ifelse($3,logical,`CALL wrf_dm_bcast_bytes( ifelse($3,real,`loc_data', `Data'), LWORDSIZE*locCount )'))
          ifelse($1,get,ifelse($4,char,   `len_of_str = LEN(ifelse($3,real,`loc_data', `Data'))'))
          ifelse($1,get,ifelse($4,char,   `CALL wrf_dm_bcast_bytes( len_of_str, IWORDSIZE )'))
          ifelse($1,get,ifelse($4,char,   `CALL wrf_dm_bcast_string( ifelse($3,real,`loc_data', `Data'), len_of_str )'))
          CALL wrf_dm_bcast_bytes( Status, IWORDSIZE )
        ENDIF
#endif
#ifdef PHDF5
      CASE ( IO_PHDF5   )
        CALL ext_phdf5_$1_$2_$6_$3$4 ( Hndl, Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') &
                                ifelse($3,real,`loc_data', `Data'), &
                                ifelse($4,char,,`locCount, ifelse($1,get,`Outcount,')') Status )
#endif
#ifdef HDF
      CASE ( IO_HDF   )
        CALL ext_hdf_$1_$2_$6_$3$4 ( Hndl, Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') &
                              ifelse($3,real,`loc_data', `Data'), &
                              ifelse($4,char,,`locCount, ifelse($1,get,`Outcount,')') Status )
#endif
#ifdef XXX
      CASE ( IO_XXX   )
        CALL ext_xxx_$1_$2_$6_$3$4 ( Hndl, Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') &
                              ifelse($3,real,`loc_data', `Data'), &
                              ifelse($4,char,,`locCount, ifelse($1,get,`Outcount,')') Status )
#endif
#ifdef YYY
      CASE ( IO_YYY   )
        CALL ext_yyy_$1_$2_$6_$3$4 ( Hndl, Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') &
                              ifelse($3,real,`loc_data', `Data'), &
                              ifelse($4,char,,`locCount, ifelse($1,get,`Outcount,')') Status )
#endif
#ifdef INTIO
      CASE ( IO_INTIO   )
        IF ( multi_files(io_form) .OR.  wrf_dm_on_monitor() ) THEN
           CALL ext_int_$1_$2_$6_$3$4 ( Hndl, Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') &
                                 ifelse($3,real,`loc_data', `Data'), &
                                 ifelse($4,char,,`locCount, ifelse($1,get,`Outcount,')') Status )
        ENDIF
        IF ( .NOT. multi_files(io_form) ) THEN
  ...
  ELSE IF ( for_out .AND. use_output_servers() ) THEN
    CALL wrf_quilt_$1_$2_$6_$3$4 ( Hndl, Element, ifelse($6,td,`DateStr,') ifelse($2,var,`Varname,') &
                          ifelse($3,real,`loc_data', `Data'), &
                          ifelse($4,char,,`locCount, ifelse($1,get,`Outcount,')') Status )
  ELSE
    Status = 0
...
ifelse($3,real,`ifelse($1,get,`Data ifelse($5,arr,(1:Outcount),) = loc_data ifelse($5,arr,(1:Outcount),)')')

ifelse($3,real,`ifelse($1,get,`ifelse($5,arr,`print *, "data(1)=", data(1)')')')
...
md_interface(get,dom,real8,,ti)
md_interface(put,dom,real8,,ti)
...
md_interface(get,dom,real8,,td)
md_interface(put,dom,real8,,td)
...
md_interface(get,var,real8,,ti)
md_interface(put,var,real8,,ti)
...
md_interface(get,var,real8,,td)
md_interface(put,var,real8,,td)
...
md_call(get,dom,real8,,ti)
md_call(put,dom,real8,,ti)
...
md_call(get,dom,real8,,td)
md_call(put,dom,real8,,td)
...
md_call(get,var,real8,,ti)
md_call(put,var,real8,,ti)
...
md_call(get,var,real8,,td)
md_call(put,var,real8,,td)
