 ...
 *   $Header: /homes/gropp/cvsMaster_z/parallel-netcdf/src/utils/ncdump/dumplib.c,v 1.3 2004/12/23 19:31:02 robl Exp $
 *********************************************************************/
...
#define	MAX_CFMT_LEN	100	/* max length of C format attribute */
	...
	if (cfmt_type == NC_CHAR && cfmt_len != 0 && cfmt_len < MAX_CFMT_LEN) {
	    int ncmpi_stat = ncmpi_get_att_text(ncid, varid, "C_format", cfmt);
