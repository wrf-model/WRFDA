...
if ( ! $?DELTA_X )          setenv DELTA_X 90000
if ( ! $?DELTA_Y )          setenv DELTA_Y 90000
if ( ! $?PTOP_PA )          setenv PTOP_PA 5000.0
if ( ! $?HINTERP_METHOD )   setenv HINTERP_METHOD 1
if ( ! $?SILAVWT_PARM_WRF ) setenv SILAVWT_PARM_WRF 2.0

echo "Hardwired default CONUS domain vertical levels."
set VERTICAL_LEVELS = ( " 1.000, 0.990, 0.978, 0.964, 0.946, "\
...
#set VERTICAL_LEVELS = ( " 1.000, 0.993, 0.980, 0.966, 0.950, "\
...
#set VERTICAL_LEVELS = ( " 1.000, 0.995, 0.992, 0.983, 0.975, "\
...
while ( $DATE <= $END_DATE )
   ...
   ln -sf ${AVN_DIR}/${AVN_FILE} ${AVN_DIR}/tmp/${AVN_FILE}
