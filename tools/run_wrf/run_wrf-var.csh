...
#          02/21/06  Renamed run_wrf-var.csh in run_wrf scripts.Dale Barker
#
#-----------------------------------------------------------------------
...
#set echo
 ...
 echo ""
 echo "Running script run_wrf-var"
 echo "--------------------------"
 echo ""
...
#Default directories/files:
 ...
 if ( ! $?BIN_DIR )    setenv BIN_DIR ${WRFVAR_DIR}/tools/run_wrf
...
#-----------------------------------------------------------------------
 ...
 mkdir ${RUN_DIR}/${DA_ID} >&! /dev/null
 cd $RUN_DIR/${DA_ID}
 echo "Running in directory $RUN_DIR/${DA_ID}"
...
echo "Creating namelist.3dvar file"
...
echo "Created namelist.3dvar file"
